...
subprocess.run(['xcrun', 'clang++', '-std=c++17', '-O2', '-bundle' , '-arch', 'arm64', '-fobjc-arc',
    '-DPitchCanvas=PitchCanvas39', '-Wall', '-Wextra', '-Werror', '-Wno-unused-parameter', '-Wno-cast-function-type-mismatch',
    '-DPitchRenderSession=PitchRenderSession39', '-DPitchDocumentStore=PitchDocumentStore39',
